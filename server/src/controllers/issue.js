...
const getAllIssues = async (req, res, next) => {
  ...
  res.status(responseCode.RESPONSE_OK).json(issues);
};
const createIssue = async (req, res, next) => {
  ...
  res.status(responseCode.RESPONSE_CREATED).json(issue);
};

const getIssue = async (req, res, next) => {
  const { id } = req.params;
  const issue = await issueService.getIssue(id);
  res.status(responseCode.RESPONSE_OK).json(issue);
};
...
const patchIssue = async (req, res, next) => {
  ...
  const issue = await issueService.getIssue(id);
  return res.status(responseCode.RESPONSE_OK).json(issue);
};
...
const createComment = async (req, res, next) => {
  ...
  res.status(responseCode.RESPONSE_CREATED).json(comment);
};
...
const addAssignee = async (req, res, next) => {
  ...
  try {
    ...
    return res.status(responseCode.RESPONSE_CREATED).json(issueResult);
  } catch (err) {
    return next(err);
  }
};
...
const removeAssignee = async (req, res, next) => {
  ...
  try {
    ...
    const issueResult = await issueService.getIssue(issueId);
    return res.status(responseCode.RESPONSE_OK).json(issueResult);
  } catch (err) {
    return next(err);
  }
};
